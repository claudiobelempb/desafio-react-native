...
export default function App() {
  ...
  async function handleLikeRepository(id) {
    ...
    const likesRepositorie = response.data
    console.log('Result: ' + likesRepositorie)
    
    const repositoriesUpdate = repositories.map((repositorie) => {
      if(repositorie.id === id){
        return likesRepositorie
      }else {
        return repositorie
      }
    })
  ...
  return (
    <>
      ...
      <FlatList
        data={repositories}
        keyExtracto={repositorie => repositorie.id}
          ...
          <SafeAreaView style={styles.container}>
            <View style={styles.repositoryContainer}>
              ...
              <View style={styles.likesContainer}>
                ...
                >
                  {repositorie.likes} curtidas {repositorie.likes > 1 ? 's' : ''}
                </Text>
              </View>
